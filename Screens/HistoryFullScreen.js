  ...
  return (
    <SafeAreaView style={{
        ...
        <ScrollView style={{ flex: 1, flexDirection: "column", gap: 5, paddingVertical: 10, paddingHorizontal: 10 }}>
            {/* <View><Text>{studentApplicationData.name.firstName}</Text></View> */}
            <Image  source={studentData?.image=='NA' ?   avatar:   { uri: studentData.image }  } style={[styles.ImProp]} />
...
export default HistoryFullScreen
